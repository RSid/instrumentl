class FilingParserController < ApplicationController
        ...
        for f in file_list do 
            ...
            for recipient_award_element in award_and_recipient_list do
                ...
                if recipient_award_element.element_children.length > 0
                    award = parse_award(recipient_award_element, filer.id)
                    receiver = parse_receiver(recipient_award_element)

                    award.build_receiver(ein: receiver.ein, 
                        name: receiver.name, 
    ...
    def parse_award(recipient_award_element, filer_id)
    ...
    def parse_receiver(recipient_award_element)
